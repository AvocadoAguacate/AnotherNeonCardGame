  ...
  constructor(){
    ...
    this.translations = {
      en: {
        ...
        NOTREADY: "Not Ready",
        RUNAWAY: "Run Away",
        INTROBASIC: "Play a card that matches in color or symbol with the one in play. If a card has two colors, both will be available for the next turn. This game is not on your side, and everyone could lose.",
        INTRODEATH: "There is a maximum number of cards you can hold in your hand to avoid losing, and this limit decreases over time. Other players can take your cards, and having none also eliminates you. You are free to take as many cards as you want at any time. If you play an invalid card or if your turn time runs out without playing, you must take a card as punishment.",
        INTROWIN: "There are two ways to win. The miserable way is to play your last card, different from discarding them all due to the effect of a card. The proper way to win is to be the last survivor, if you manage to get there.",
        c10TITLE: "Halfway",
